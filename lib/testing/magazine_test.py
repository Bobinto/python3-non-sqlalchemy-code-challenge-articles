...
from lib.classes.classes.many_to_many import Article
from lib.classes.classes.many_to_many import Magazine
from lib.classes.classes.many_to_many import Author
